...
using SignalRProject.UI.DTOs.AboutDTOs;
using System.Text;
...
namespace SignalRProject.UI.Controllers
{
    public class AboutController : Controller
    {
        ...
        public async Task<IActionResult> CreateAbout(CreateAboutDTO createAboutDTO)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7059/api/About", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
        ...
        public async Task<IActionResult> UpdateAbout(UpdateAboutDTO updateAboutDTO)
        {
            ...
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            var responseMessage = await client.PutAsync("https://localhost:7059/api/About/", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
